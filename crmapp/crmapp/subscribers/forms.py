...
class SubscriberForm(AddressMixin, UserCreationForm):
    ...
    password1 = forms.CharField(widget= forms.TextInput(attrs={'class':'form_control','type':'password'}))
    password2 = forms.CharField(widget= forms.TextInput(attrs={'class':'form_control','type':'password'}))